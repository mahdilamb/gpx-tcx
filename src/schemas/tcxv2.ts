...
type ActivityLap<attrK extends string, ExtT> = Omit<
  v1.ActivityLap<attrK, ExtT>,
  'Calories' | 'AverageHeartRateBpm' | 'MaximumHeartRateBpm' | 'Cadence'
> & {
...
export type TCXv2Document<attrK extends string = '$', ExtT = any> = {
